...
<title>Bienvenido/a Doctor/a ${medico.name } </title>
...
<script type="text/javascript">
        function nuevaCita() {
                document.getElementById('detalleCita').action = "#nuevacita";
                document.getElementById("detalleModal").hidePopup(); // Submitting form
