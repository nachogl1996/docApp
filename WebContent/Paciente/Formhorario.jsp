<div class="col-md-2">
	<h4>
		<a href="CargaCitasServlet?inicio=${fechainicio }&mover=retrocede" class="btnamplia btn-white-fill"> < </a>
	</h4>
</div>
...
<div class="col-md-2 col-md-offset-2">
	<h4>
		<a href="CargaCitasServlet?&inicio=${fechainicio }&mover=avanza" class="btnamplia btn-white-fill"> > </a>
	</h4>
</div>
<div class="row section-padded">
	...
	<c:forEach items="${horario}" var="cita">
		...
		<c:if test="${cita.status==0 }">
			<a class="btnreducido btn-green-fill" href="PedirCitaServlet?cita=${cita.date }&medico=${medicoemail }">Reservar </a>
		</c:if>
		<c:if test="${cita.status >0 }">
