...
@WebServlet("/UsuarioEspecialidadMedicoServlet")


public class UsuarioEspecialidadMedicoServlet extends HttpServlet{
	
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		String especialidadps = req.getParameter("esp");
		String pacienteEmail = req.getParameter("paciente");
		List<Medico> medicos = MedicoDAOImplementation.getInstance().readMedicoEspecialidad(especialidadps);	
		Paciente paciente = PacienteDAOImplementation.getInstance().readPaciente(pacienteEmail);
