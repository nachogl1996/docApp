...
@WebServlet("/CargaHorarioModificarAdminServlet")
public class CargaHorarioModificarAdminServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Medico medico = MedicoDAOImplementation.getInstance().readMedico(cita.getMedico().getEmail());
